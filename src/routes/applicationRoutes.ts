...
import { submitApplication, getAllApplications, getUserApplications, downloadCV, deleteApplication, updateApplicationStatus } from '../controllers/applicationController';
